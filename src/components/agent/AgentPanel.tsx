      ...
      <header className="border-b border-navy-100 bg-white px-4 py-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-navy-900">Coreveo AI Agent</p>
      ...
      <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4">
        {messages.length === 0 ? (
          <div className="rounded-xl border border-dashed border-navy-200 bg-white px-3 py-4 text-sm text-navy-600">
            The dashboard shows what is happening. Ask Coreveo why it is happening and what should happen next.
      ...
      <footer className="border-t border-navy-100 bg-white p-3">
        ...
        >
          <textarea
            ...
            rows={2}
            placeholder="Ask Coreveo about this exception, customer, service or operational trend..."
