  ...
  return (
    <div className="space-y-5">
      ...
      <input
        ...
        className="w-full max-w-xl rounded-lg border border-navy-200 bg-white px-3 py-2 text-sm outline-none focus:border-accent focus:ring-2 focus:ring-blue-100"
      />
